...
contract RootTest is BaseTest {
    ...
    function test_buy_sheep() public {
        ...
        (int16 _x, int16 _y, address _owner, uint32 _id, uint32 _blood, uint32 _bornTime, uint32 _updateTime, uint256 _height ,uint256 _value) = room.getSheep(4);
        console2.log("x %s", _x);
        console2.log("y %s", _y);
        console2.log("address %s", _owner);
        console2.log("id %s", _id);
        ...
        console2.log("bornTime %s", _bornTime);
        console2.log("updateTime %s", _updateTime);
        console2.log("block height %s", _height);
        console2.log("value %s", _value);
    }
    ...
    function test_buy_and_sell_sheep() public {
        ...
        uint32[] memory sheepIds = room.getSpecieIdsAt(1, 1, 1);
        assertEq(sheepIds[0], 1);
        assertEq(sheepIds[1], 5);
        assertEq(sheepIds[2], 3);
        assertEq(sheepIds[3], 4);

    
        (int16 _x, int16 _y, address _owner, uint32 _id, uint32 _blood, uint32 _bornTime, uint32 _updateTime, uint256 _height ,uint256 _value) = room.getSheep(5);
        console2.log("x %s", _x);
        console2.log("y %s", _y);
        console2.log("address %s", _owner);
        console2.log("id %s", _id);
